...
test('checkHorizontalWin returns true when there is a horizontal win for player index', () => {
  let grid = List(times(42, i => i))
    ...
    .set(39, 0)
    .set(40, 0);
  expect(checkHorizontalWin(grid, 6, 7, 0)).toBeTruthy();
  ...
  expect(checkHorizontalWin(grid, 6, 7, 1)).toBeTruthy();
});
...
test('checkVerticalWin returns true when there is a Vertical win for player index', () => {
  let grid = List(times(42, () => null))
    ...
    .set(28, 0)
    .set(35, 0);
  expect(checkVerticalWin(grid, 6, 7, 0)).toBeTruthy();
  ...
  expect(checkVerticalWin(grid, 6, 7, 1)).toBeTruthy();
  grid = List(times(42, i => null))
    .set(11, 1)
    .set(18, 1)
    .set(25, 1)
...
test('checkDiagonalWinLeftToRight return true when there is a diagonal win from top left to bottom right', () => {
  let grid = List(times(42, i => null))
    ...
    .set(16, 0)
    .set(24, 0);
  expect(checkDiagonalWinLeftToRight(grid, 6, 7, 0)).toBeTruthy();
  ...
  expect(checkDiagonalWinLeftToRight(grid, 6, 7, 1)).toBeTruthy();
  grid = List(times(42, i => null))
    .set(3, 0)
    .set(11, 0)
    .set(19, 0)
...
test('checkDiagonalWinRightToLeft return true when there is a diagonal win from top right to bottom left', () => {
  let grid = List(times(42, i => null))
    ...
    .set(18, 0)
    .set(24, 0);
  expect(checkDiagonalWinRightToLeft(grid, 6, 7, 0)).toBeTruthy();
  ...
  expect(checkDiagonalWinRightToLeft(grid, 6, 7, 1)).toBeTruthy();
  grid = List(times(42, i => null))
    .set(3, 0)
    .set(9, 0)
    .set(15, 0)
